...
| Schema | Objects |
|--------|---------|
| APPLICATIONS | FLUX_OPS_CENTER_KPIS, TOPOLOGY_METRO, TOPOLOGY_FEEDERS, SERVICE_AREAS_MV, VEGETATION_RISK_COMPUTED, CIRCUIT_HEALTH_REALTIME (DT), CIRCUIT_OUTAGE_STATUS (VIEW) |
