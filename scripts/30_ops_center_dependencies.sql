...
INSERT INTO NODE_CENTRALITY_FEATURES_V2 (NODE_ID, DEGREE_CENTRALITY, BETWEENNESS_CENTRALITY, CLOSENESS_CENTRALITY, EIGENVECTOR_CENTRALITY, PAGERANK_SCORE, CLUSTERING_COEFFICIENT, LOCAL_EFFICIENCY, CASCADE_IMPACT_SCORE, VULNERABILITY_SCORE, CASCADE_RISK_SCORE_NORMALIZED, CRITICALITY_RANK, NODE_TYPE, SUBSTATION_ID, LOAD_FACTOR, MODEL_VERSION)
SELECT 
    n.NODE_ID,
    n.DEGREE_CENTRALITY,
