--!jinja2
-- =============================================================================
-- 10_cortex_agent.sql (Git Integration Version)
...
--   {{ user_role }}  - Role to grant agent usage (optional, defaults to PUBLIC)
--
-- Usage with Git Integration:
--   EXECUTE IMMEDIATE FROM @repo/branches/main/scripts/git/10_cortex_agent.sql
--       USING (database => 'FLUX_DEV', user_role => 'FLUX_DEV_USER');
--
-- Usage with Snow CLI:
--   snow sql -f scripts/git/10_cortex_agent.sql --enable-template-syntax=JINJA \
